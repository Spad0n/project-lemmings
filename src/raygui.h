...
// Color Panel control
int GuiColorPanel(Rectangle bounds, const char __attribute__((unused)) *text, Color *color)
{
    int result = 0;
    GuiState state = guiState;
...
int GuiColorBarAlpha(Rectangle bounds, const char __attribute__((unused)) *text, float *alpha)
{
...
int GuiColorBarHue(Rectangle bounds, const char __attribute__((unused)) *text, float *hue)
{
    int result = 0;
    GuiState state = guiState;
...
int GuiColorPicker(Rectangle bounds, const char __attribute__((unused)) *text, Color *color)
{
    int result = 0;
...
int GuiColorPickerHSV(Rectangle bounds, const char __attribute__((unused)) *text, Vector3 *colorHsv)
{
    int result = 0;
...
int GuiColorPanelHSV(Rectangle bounds, const char __attribute__((unused)) *text, Vector3 *colorHsv)
{
    int result = 0;
    GuiState state = guiState;
    Vector2 pickerSelector = { 0 };
...
int GuiGrid(Rectangle bounds, const char __attribute__((unused)) *text, float spacing, int subdivs, Vector2 *mouseCell)
{
...
const char *GuiIconText(int __attribute__((unused)) iconId, const char __attribute__((unused)) *text)
{
#if defined(RAYGUI_NO_ICONS)
    return NULL;
#else
...
static void GuiLoadStyleFromMemory(const unsigned char *fileData, int __attribute__((unused)) dataSize)
{
...
static const char *GetTextIcon(const char *text, int __attribute__((unused)) *iconId)
{
#if !defined(RAYGUI_NO_ICONS)
    *iconId = -1;
